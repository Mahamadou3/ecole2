...
<body>
    ...
    <h1>Formulaire modification professeur</h1>
    ...
    <div class="form-container">
        <form action="../../controllers/ProfesseurCtrl.php" method="post">
            ...
            <input type="text" name="matricule" id="maticule" value="<?= $professeurs['matricule'] ?>" readOnly autocomplete="off" required>

            <label for="nom">NOM</label>
            <input type="text" name="nom" id="nom" value="<?= $professeurs['nom'] ?>" autocomplete="off" required>

            <label for="prenom">PRENOM</label>
            <input type="text" name="prenom" id="prenom" value="<?= $professeurs['prenom'] ?>" required>
            ...
            <label for="matiere">SPÉCIALITÉ</label>
            <input type="text" name="matiere" id="matiere" value="<?= $professeurs['matiere'] ?>" required>

            <label for="tel">TÉLÉPHONE</label>
            <input type="number" name="tel" id="tel" value="<?= $professeurs['tel'] ?>" required>
